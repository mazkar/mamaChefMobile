...
const AutoTextCompleteInput2 = ({
  ...
  return (
    <View style={styles.container}>
      <TextInput
        style={{
          ...
          borderColor: focusTextInput
            ...
            : COLORS.GRAY_MEDIUM,
          paddingVertical: focusTextInput ? 10 : 10,
      ...
      {handleError && <TextError label={labelError} style={styles.txtErr} />}
    </View>
  );
};
...
export default AutoTextCompleteInput2;
