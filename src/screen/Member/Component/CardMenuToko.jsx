...
import PopUpConfirm2 from "./PopUpConfirm2";
...
export default function CardMenuToko({
  photoUrl,
  namaMember,
  tglLahir,
  notes,
  ...
  const handleClick = (memberId, toko, hp, stat) => {
    console.log(memberId, stat);
    handleUpdate(memberId, toko, hp, stat);
    setPopVisible(false);
  };
      ...
      >
        ...
        >
          ...
          /> */}
            <Avatar.Text
              size={86}
              label={namaMember?.charAt(0)?.toUpperCase()}
            />
